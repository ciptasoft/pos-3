			...
			<div class="col-md-2 col-sm-6">
				<div class="dashbord_inner">
					<ul class="list-group">
						...
						<li class="list-group-item"><a href="<?="?ref=users" ?>"> <i class="ion-ios-person-outline"></i> Users</a></li>
						<li class="list-group-item"><a href="<?="?ref=settings" ?>"> <i class="ion-ios-settings"></i> Settings</a></li>
						<li class="list-group-item"><a href="<?="?ref=about" ?>"> <i class="ion-ios-information-outline"></i> About</a></li>
					</ul>
				</div>
			</div>
		</div>
		<?php require 'bs-admin/routes.php'; ?>
